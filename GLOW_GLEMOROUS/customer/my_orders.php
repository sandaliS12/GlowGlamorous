...
<div class="table-responsive"><!--  table-responsive Begin  -->
    ...
    <table class="table table-bordered table-hover"><!--  table table-bordered table-hover Begin  -->
        ...
        <tbody><!--  tbody Begin  -->
            ...
            $customer_name = $row_customer['user_id'];
            
            $get_orders = "select * from orders where cus_id='$customer_id'";
            ...
            while($row_orders = mysqli_fetch_array($run_orders)){
                ...
                $order_id = $row_orders['o_id'];
                
                $due_amount = $row_orders['amount'];
                
                $invoice_no = $row_orders['invo_no'];
                
                $qty = $row_orders['quantity'];
                
                $size = $row_orders['size'];
                
                $order_date = substr($row_orders['ord_date'],0,11);
                
                $order_status = $row_orders['ord_status'];
