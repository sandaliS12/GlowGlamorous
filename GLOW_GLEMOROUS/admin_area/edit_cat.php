...
<?php 
    ...
    if(isset($_GET['edit_cat'])){
        ...
        $edit_cat_query = "select * from main_categories where cat_id='$edit_cat_id'";
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_cat = "update main_categories set cat_title='$cat_title',cat_desc='$cat_desc' where cat_id='$cat_id'";
