            ...
            <ul class="dropdown-menu"><!-- dropdown-menu begin -->
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_products"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-envelope"></i> Items
                ...
                <li><!-- li begin -->
                    <a href="index.php?view_cats"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-gear"></i> Item Categories
        ...
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#products"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-tag"></i> Items
                ...
                <ul id="products" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?product_insert"> Insert Items </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#p_cat"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-edit"></i> Item Categories
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="p_cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?item_cat_insert"> Insert Item Category </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_p_cats"> View Item Categories </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#cat"><!-- a href begin -->
                        ...
                        <i class="fa fa-fw fa-book"></i> Main Categories
                        <i class="fa fa-fw fa-caret-down"></i>
                ...
                <ul id="cat" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?main_cat_insert"> Insert Main Category </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_cats"> View Main Categories </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
