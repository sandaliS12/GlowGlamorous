...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_query = "select * from item_categories where p_cat_id='$edit_p_cat_id'";
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $update_p_cat = "update item_categories set p_cat_title='$p_cat_title',p_cat_desc='$p_cat_desc' where p_cat_id='$p_cat_id'";
